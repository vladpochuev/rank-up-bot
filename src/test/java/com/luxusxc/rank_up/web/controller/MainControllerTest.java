...
public class MainControllerTest {
    @MockBean
    private WebConfigHandler configurer;
    @MockBean
    ...
    void testGet() throws Exception {
        when(configurer.exportWebConfig()).thenReturn(new WebConfig());
        mockMvc
                .perform(get(""))
    ...
    void testPost() throws Exception {
        ...
        ArgumentCaptor<WebConfig> captor = ArgumentCaptor.forClass(WebConfig.class);
